...
import { MINIMAX_DEFAULT_MODEL, MINIMAX_MODEL_IDS } from '@/lib/providers/minimax'
            ...
            <Select
              ...
              onValueChange={value => {
                ...
                if (newProvider === 'anthropic') {
                  ...
                  savedModel = localStorage.getItem('humanlayer-minimax-model') || MINIMAX_DEFAULT_MODEL
                }
