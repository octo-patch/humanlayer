...
import { MINIMAX_BASE_URL, MINIMAX_DEFAULT_MODEL, isMiniMaxBaseUrl } from '@/lib/providers/minimax'
  ...
  useEffect(() => {
    ...
    if (
      ...
      if (lastUsedProvider === 'anthropic' && lastUsedModel) {
        ...
        setProvider('minimax')
        setProxyEnabled(true)
        setProxyBaseUrl(lastUsedProxyBaseUrl || MINIMAX_BASE_URL)
  ...
  const handleModelChange = useCallback(
    (config: {
      ...
      if (config.provider === 'anthropic') {
        ...
        setLastUsedProxyBaseUrl(MINIMAX_BASE_URL)
      }
